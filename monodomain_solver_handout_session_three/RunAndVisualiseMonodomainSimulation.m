function [ finalVoltage, conductionVelocities, times ] = RunAndVisualiseMonodomainSimulation( numberCells, simulationDuration, leftHalfFibreConductivity, rightHalfFibreConductivity, visualiseSimulation)
